...
| Profile Config | Immutable JSON config for the Rust launcher: image ref/source/source kind, agent, mounts, env, network allowlist, service features | `ProfileConfig` generated by `mkSandbox` |

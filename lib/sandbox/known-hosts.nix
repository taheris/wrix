...
# SSH known_hosts file for sandboxed containers
# Using writeTextDir for Apple container VirtioFS compatibility (directory mounts only)
#
# Security: These keys are hardcoded from GitHub's official documentation:
...
#   ssh-keygen -lf <(echo "github.com <key>")
pkgs.writeTextDir "known_hosts" ''
